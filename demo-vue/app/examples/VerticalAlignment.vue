<template>
    <Page>
        ...
        <ScrollView>
            <StackLayout>
            <HTMLLabel fontSize="20" width="100%" backgroundColor="red" height="100" lineHeight="0" color="green" textWrap="true" html='<span style="color:blue;font-size:26;font-style:italic;font-family:res/cabinsketch;">left textAlignment</span>, top verticalAlignment' verticalTextAlignment="top"/>
